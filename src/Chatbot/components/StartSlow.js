...
export default function StartSlow(props) {
    ...
    return (
        <div>
            <button className='start-btn' onClick={() => preference("WebDevelopmet")}>WebDevelopmet</button>
            <button className='start-btn slow-btn' onClick={() => preference("AppDevelopment")}>AppDevelopment</button>
        </div >
    )
}